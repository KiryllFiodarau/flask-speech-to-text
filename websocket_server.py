...
json_config_info = {
  ...
  "service_account_impersonation_url": "https://iamcredentials.googleapis.com/v1/projects/-/serviceAccounts/test0-0@gcp-subtitles.iam.gserviceaccount.com:generateAccessToken"
}
